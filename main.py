...
def send_report_email_task(email: str, sender_email: str, api_key: str, pdf_bytes: bytes, filename: str):
    try:
...
async def send_report_endpoint(request: SendReportRequest, background_tasks: BackgroundTasks):
    try:
        ...
        background_tasks.add_task(send_report_email_task, request.email, sender_email, api_key, pdf_bytes, filename)
